...
#SBATCH --gres=gpu:GRTX8000:1
#SBATCH --time=1:00:00
#SBATCH --output=slurm_fdtd_rtx8000_%j.out
#SBATCH --chdir=/clusterfs/csd/amos/ycnliu/check_gpu/fdtd_bench

echo "=== FDTD Benchmark on RTX 8000 (sm_75) ==="
